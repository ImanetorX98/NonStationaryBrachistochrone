...
Hamiltonian analysis of a second preprint, concerns a different work which I have
not been able to obtain. I note only that equation~(1) of Paper~I is the rail
constraint $-u\cdot W=\hat E$, which is the \emph{definition} of the control
problem rather than a derived result, so it is not clear to me what it would mean
for it to be obtained from a prior analysis.
