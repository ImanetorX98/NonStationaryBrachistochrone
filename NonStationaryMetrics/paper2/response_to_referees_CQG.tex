...
For ingoing Vaidya with the Kodama selector the only nonvanishing component is
$(\mathcal L_Kg)_{vv}=2m'(v)/r$ with $\nabla\!\cdot\!K=0$, so $K$ is not even
conformal Killing once $m'\neq0$, and
$\dd\hat E/\dd\tau|_{\rm geodesic}=-m'(v)(u^v)^2/r$.
