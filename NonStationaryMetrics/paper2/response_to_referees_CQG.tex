...
\reply I have now read the cited preprint, and with respect I do not think the
requested characterisation can be made. Theorem~T2 there reads, in full:
...
Lipschitz $C^1$ dense map $\psi:(P^m,g_{ij})\to(Q^n,h_{ij})$. This is the standard
horizontal-weak-conformality dichotomy of harmonic-morphism theory, and it is a
statement about the differential of a \emph{map between manifolds} at a point.

The specific claim is checkable, and I have checked it. Equation~(9) of the
submitted manuscript is
\[
...
first-/second-kind basis. I can see no route from a dichotomy about semiconformal
maps to a reduction of abelian integrals, and I do not believe the two belong to
the same area.
