...
structure just as they disagree about depth. What we still do not have, even on
...
preprint---a Riemannian submersion of complete manifolds with connected fibres is
Clairaut, so that the transverse invariant is conserved along geodesics, if and
only if its fibres are totally umbilical \emph{with mean curvature of gradient
