...
harmonic (\emph{ibid.}, \S7). That version is the useful one, because it says
what semiconformality does not give: our projection is semiconformal by
computation, and it would be a harmonic morphism only if its tension field vanished
too, which I do not claim. The framework therefore accounts for the conformal
\emph{form} of the optical metric and for nothing beyond it.
