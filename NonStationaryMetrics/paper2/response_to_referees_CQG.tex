...
that sector, and in the non-rotating frozen limit, the statements are fully
three-dimensional. It is the rotating case, where the rotation group is broken to
$U(1)$ and no symmetry supplies the field, that genuinely needs the equatorial
restriction; we do not treat it. Global minimality thus holds within
homotopy classes and fails between them, the failure being exactly the Maxwell
set.
